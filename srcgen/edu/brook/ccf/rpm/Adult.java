 ...
 * 
 * Generated by metaabm system: Mar 4, 2009 8:11:35 PM PST in project: edu.brook.parent.escape  */
...
public class Adult extends org.ascape.model.CellOccupant {
	...
	private PregnancyRelationshipStatusEnum pregnancyRelationshipStatus = PregnancyRelationshipStatusEnum.neverPregnant;
	/**
	 * 
	 */
	...
	public void initializeLocation() {

		{
			...
			NeighborhoodCell adult = (NeighborhoodCell) ((org.ascape.model.space.Discrete) getRelationshipsAndPregnancy()
	...
	public void initializeAges() {

		{
			...
			int initializeAgesAgeinYearsSubtractMinimumAge = getAgeinYears() - 15;
				...
				if (assignedSpouse != null) {
					...
					if (assignedSpouse.getID() == getSpouseID()) {
						...
						if (getGender() == GenderEnum.female
								&& assignedSpouse.getID() == getSpouseID()) {

							{

								NeighborhoodCell assignedSpouseNeighborCell = (NeighborhoodCell) ((org.ascape.model.space.Discrete) getRelationshipsAndPregnancy()
						...
						public boolean meetsCondition(Object adultNearAgeCell) {
							...
							if (adultNearAgeCell instanceof Adult) {
								...
								return (getEducation() == adultNearAge
										.getEducation() && adultNearAge
										.getAgeGroup() == adultNearAge
										.getAgeGroup());
							} else {
								return false;
							}
...

							{
															...
															org.ascape.util.Conditional femalePartnerSterilizationCondition = new org.ascape.util.Conditional() {
																...
																public boolean meetsCondition(
																	...
																	if (femalePartnerSterilizationCell instanceof Adult) {
																		Adult femalePartnerSterilization = (Adult) femalePartnerSterilizationCell;
																		return true;
																	} else {
																		return false;
																	}
...

								{

									{
										...
										if (getMaritalStatus() == MaritalStatusEnum.married
												&& getDaysinCurrentRelationship() > 0) {
										...
										if (getMaritalStatus() != MaritalStatusEnum.married
...

											{
												...
												if (getGender() == GenderEnum.female
														&& getMaritalStatus() != MaritalStatusEnum.married
														&& getDaysinCurrentRelationship() > 0) {

													double marriageDrawSubsequent = getRandom()
															.nextDouble();

													double pregnancyStatusAdjustment = pregnancyStatusAdjustment();

													double pregnancyAdjustedPMarriage = getPMarriage()
															* pregnancyStatusAdjustment;

													{

														if (marriageDrawSubsequent < pregnancyAdjustedPMarriage) {

															{
																org.ascape.util.Conditional marriagePartnerCondition = new org.ascape.util.Conditional() {
																	...
																	public boolean meetsCondition(
																		...
																		if (marriagePartnerCell instanceof Adult) {
																			Adult marriagePartner = (Adult) marriagePartnerCell;
																			return true;
																		} else {
																			return false;
																		}
																...
																if (marriagePartner != null) {
																	...
																	double partnerAdjustedPMarriage = getPMarriage()
																			* pregnancyStatusAdjustment;

																	{

																		if (marriageDrawSubsequent < partnerAdjustedPMarriage) {
															...
															org.ascape.util.Conditional relationshipPartnerCondition = new org.ascape.util.Conditional() {
																...
																public boolean meetsCondition(
																	...
																	if (relationshipPartnerCell instanceof Adult) {
																		Adult relationshipPartner = (Adult) relationshipPartnerCell;
																		return true;
																	} else {
																		return false;
																	}
					...
					org.ascape.util.Conditional femalePartnerCondition = new org.ascape.util.Conditional() {
						...
						public boolean meetsCondition(Object femalePartnerCell) {
							if (femalePartnerCell instanceof Adult) {
								Adult femalePartner = (Adult) femalePartnerCell;
								return true;
							} else {
								return false;
							}
...

			{

				{
...

					{
						...
						if ((isPregnant() && getPregnancyRelationshipStatus() == PregnancyRelationshipStatusEnum.neverPregnant)) {
...

			{

				{
...

					{
						...
						if ((getContraceptionMethod() != ContraceptionMethodEnum.sterilized
								&& getGender() == GenderEnum.female && !isPregnant())) {
								...
								org.ascape.util.Conditional malePartnerCondition = new org.ascape.util.Conditional() {
									...
									public boolean meetsCondition(
										...
										if (malePartnerCell instanceof Adult) {
											Adult malePartner = (Adult) malePartnerCell;
											return true;
										} else {
											return false;
										}
								...
								if (malePartner != null) {

									{
										...
										if (malePartner
											...
											double basePregnancyProbability = getRelationshipsAndPregnancy()
											...
											double pregnancyProbabilityforAge = basePregnancyProbability
													* fecundityForAge;

											{
												...
												if (malePartner
													...
													double sexEventRandomUnit = getRandom()
															.nextDouble();
...

												{

													{
														...
														if ((getContraceptionMethod() == ContraceptionMethodEnum.pill && malePartner
															...
															double pregnancyProbabilityWithPillCondom = pregnancyProbabilityforAge
																	* getRelationshipsAndPregnancy()
																			.getPillCondomFailureRate();

															{

																if (pregnancyDraw < pregnancyProbabilityWithPillCondom) {
														...
														if ((getContraceptionMethod() == ContraceptionMethodEnum.pill && malePartner
															...
															double pregnancyProbabilityPillOnly = pregnancyProbabilityforAge
																	* getRelationshipsAndPregnancy()
																			.getPillFailureRate();

															{

																if (pregnancyDraw < pregnancyProbabilityPillOnly) {
...

												{

													{
														...
														if (pregnancyDraw < pregnancyProbabilityforAge
																&& !((malePartner
																		.getContraceptionMethod() == ContraceptionMethodEnum.condomMediumIntender
																		|| malePartner
	...
	/**
	 * metaabm::act::AEvaluate Pregnancy Status Adjustment.
	 */

	public double pregnancyStatusAdjustment() {

		double pregnancyStatusAdjustmentMinimum = 0.0;

		pregnancyStatusAdjustmentMinimum = getRelationshipsAndPregnancy()
				.getPregnancyStatusAdjustmentMinimumBase();
		switch (getPregnancyRelationshipStatus()) {
			case neverPregnant :
				pregnancyStatusAdjustmentMinimum = pregnancyStatusAdjustmentMinimum
						+ getRelationshipsAndPregnancy()
								.getPregnancyStatusAdjustmentNeverPregnantMinimum();
				break;
			case currentlyPregnant :
				pregnancyStatusAdjustmentMinimum = pregnancyStatusAdjustmentMinimum
						+ getRelationshipsAndPregnancy()
								.getPregnancyStatusAdjustmentCurrentlyPregnantMinimum();
				break;
			case wasPregnant :
				pregnancyStatusAdjustmentMinimum = pregnancyStatusAdjustmentMinimum
						+ getRelationshipsAndPregnancy()
								.getPregnancyStatusAdjustmentWasPregnantMinimum();
				break;
		}

		double pregnancyStatusAdjustmentMaximum = 0.0;

		pregnancyStatusAdjustmentMaximum = getRelationshipsAndPregnancy()
				.getPregnancyStatusAdjustmentMaximumBase();
		switch (getPregnancyRelationshipStatus()) {
			case neverPregnant :
				pregnancyStatusAdjustmentMaximum = pregnancyStatusAdjustmentMaximum
						+ getRelationshipsAndPregnancy()
								.getPregnancyStatusAdjustmentNeverPregnantMaximum();
				break;
			case currentlyPregnant :
				pregnancyStatusAdjustmentMaximum = pregnancyStatusAdjustmentMaximum
						+ getRelationshipsAndPregnancy()
								.getPregnancyStatusAdjustmentCurrentlyPregnantMaximum();
				break;
			case wasPregnant :
				pregnancyStatusAdjustmentMaximum = pregnancyStatusAdjustmentMaximum
						+ getRelationshipsAndPregnancy()
								.getPregnancyStatusAdjustmentWasPregnantMaximum();
				break;
		}

		return randomInRange(pregnancyStatusAdjustmentMinimum,
				pregnancyStatusAdjustmentMaximum);
	...
	/**
	 * Gets the Pregnant property for Adult.
	 * @return Am I currently pregnant?
	 */
	...
	/**
	 * Sets the Pregnant property for Adult.
	 * Am I currently pregnant?
	 * @param _pregnant the new Pregnant value
	 */

	public void setPregnant(boolean _pregnant) {
		pregnant = _pregnant;
		pregnancyEvent();
	}
	/**
	 * Gets the Pregnancy Relationship Status property for Adult.
	 * @return 
	 */

	public PregnancyRelationshipStatusEnum getPregnancyRelationshipStatus() {
		return pregnancyRelationshipStatus;
	}

	/**
	 * Sets the Pregnancy Relationship Status property for Adult.
	 * 
	 * @param _pregnancyRelationshipStatus the new Pregnancy Relationship Status value
	 */

	public void setPregnancyRelationshipStatus(
			PregnancyRelationshipStatusEnum _pregnancyRelationshipStatus) {
		pregnancyRelationshipStatus = _pregnancyRelationshipStatus;
	}
	/**
