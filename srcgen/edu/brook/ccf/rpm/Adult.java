		...
		if (!isInRelationship()) {
			...
			if (getRelationshipsAndPregnancy().getWalkTowardAge() == 1
				...
				if (adultNearAge != null) {
					...
					if (getHostScape() != ((Agent) adultNearAge).getScape()) {
						die();
						getRelationshipsAndPregnancy().getAdultScape()
								.add(this);
					}
			...
			if (malePartner != null) {
				...
				if (malePartner.getContraceptionMethod() != ContraceptionMethodEnum.sterilized) {
					...
					if (pregnancyDraw < pPregnancyAgeandCycle
							&& !((malePartner.getContraceptionMethod() == ContraceptionMethodEnum.condomMediumIntender
									|| malePartner.getContraceptionMethod() == ContraceptionMethodEnum.condomHighIntender || getContraceptionMethod() == ContraceptionMethodEnum.pill))) {
