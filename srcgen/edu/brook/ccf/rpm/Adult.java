...
public class Adult extends CellOccupant {
	...
	public void initializeLocation() {
		...
		if (initialLocation != null) {
			if (getHostScape() != ((Agent) initialLocation).getScape()) {
				die();
				getRelationshipsAndPregnancy().getAdultScape().add(this);
			}
					...
					if (getGender() == GenderEnum.female) {
						...
						if (assignedSpouseNeighborCell != null) {
							if (getHostScape() != ((Agent) assignedSpouseNeighborCell)
									.getScape()) {
								die();
								getRelationshipsAndPregnancy().getAdultScape()
										.add(this);
							}
	...
	public void movement() {
		if (!isInRelationship()) {
			...
			if (getRelationshipsAndPregnancy().getWalkTowardAge() == 1
				...
				Location adultNearAgeLocation = ((org.ascape.model.space.Discrete) getRelationshipsAndPregnancy()
						.getNeighborhood().getSpace()).findNearestAvailable(
						((org.ascape.model.CellOccupant) this).getHostCell(),
						adultNearAgeCondition, false,
						getRelationshipsAndPregnancy().getAgentVision());
	...
	public void updateDates() {
		...
		if (cyclefromAgeinDays < getRelationshipsAndPregnancy().getLunarDays()) {
	...
	public double pPillFailure() {
		...
		switch (getAgeGroup()) {
			case years15to19 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailure15to19Factor();
				break;
			case years20to24 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailure20to24Factor();
				break;
			case years25to29 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailure25to29Factor();
				break;
			case years30to44 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailure30to44Factor();
				break;
		}
		switch (getEducation()) {
			case nHS :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureNHSFactor();
				break;
			case pHS :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailurePHSFactor();
				break;
			case hS :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureHSFactor();
				break;
		}
		switch (getMaritalStatus()) {
			case married :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureMarriedFactor();
				break;
			case single :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureSingleFactor();
				break;
			case divorced :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureDivorcedFactor();
				break;
		}
		switch (getRace()) {
			case other :
		...
		switch (getSES()) {
			case cat1 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureCategory1Factor();
				break;
			case cat3 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureCategory3Factor();
				break;
			case cat2 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureCategory2Factor();
				break;
			case category4 :
				pPillFailureFactor = pPillFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillFailureCategory4Factor();
				break;
		}
		...
		switch (getAgeGroup()) {
			case years15to19 :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailure15to19Factor();
				break;
			case years20to24 :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailure20to24Factor();
				break;
			case years25to29 :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailure25to29Factor();
				break;
			case years30to44 :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailure30to44Factor();
				break;
		}
		switch (getEducation()) {
			case nHS :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailureNHSFactor();
				break;
			case pHS :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailurePHSFactor();
				break;
			case hS :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailureHSFactor();
				break;
		}
		switch (getMaritalStatus()) {
			case married :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailureMarriedFactor();
				break;
			case single :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPPillCondomFailureSingleFactor();
				break;
			case divorced :
				pPillCondomFailureFactor = pPillCondomFailureFactor
						+ getRelationshipsAndPregnancy()
	...
	public double pCondomFailure() {
		...
		switch (getAgeGroup()) {
			case years15to19 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailure15to19Factor();
				break;
			case years20to24 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailure20to24Factor();
				break;
			case years25to29 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailure25to29Factor();
				break;
			case years30to44 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailure30to44Factor();
				break;
		}
		switch (getEducation()) {
			case nHS :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureNHSFactor();
				break;
			case pHS :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailurePHSFactor();
				break;
			case hS :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureHSFactor();
				break;
		}
		switch (getMaritalStatus()) {
			case married :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureMarriedFactor();
				break;
			case single :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureSingleFactor();
				break;
			case divorced :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureDivorcedFactor();
				break;
		}
		switch (getRace()) {
			case other :
		...
		switch (getSES()) {
			case cat1 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureCategory1Factor();
				break;
			case cat3 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureCategory3Factor();
				break;
			case cat2 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureCategory2Factor();
				break;
			case category4 :
				pCondomFailureFactor = pCondomFailureFactor
						+ getRelationshipsAndPregnancy()
								.getPCondomFailureCategory4Factor();
				break;
		}
	...
	public void pregnancyBegin() {
		...
		Adult updateFatherRelationship2 = (Adult) ((org.ascape.model.space.Discrete) getRelationshipsAndPregnancy()
				.getPartners().getSpace()).findRandomNeighbor(this,
	...
	public void pregnancyEnd() {
		...
		Adult updateFatherRelationship = (Adult) ((org.ascape.model.space.Discrete) getRelationshipsAndPregnancy()
				.getPartners().getSpace()).findRandomNeighbor(this,
